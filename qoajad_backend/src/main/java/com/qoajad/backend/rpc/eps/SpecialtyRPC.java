...
import com.qoajad.backend.model.external.eps.specialty.SpecialtiesList;
...
public interface SpecialtyRPC {
    ...
    SpecialtiesList retrieveAllSpecialties(@PathVariable("healthProviderInstituteName") final String healthProviderInstituteName);
}
